        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="index.php?acao=<?php echo $item1 ?>" class="nav-link <?php $item1ativo ?>">Home</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="index.php?acao=<?php echo $item2 ?>" class="nav-link <?php $item2ativo ?>">Produtos</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="index.php" class="nav-link <?php $item3ativo ?>">Categorias</a>
                </li>
            </ul>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <a href="#" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                                <img src="../../images/no-user-1.png" alt="User Avatar"
                                ...
                                <div class="media-body">
                                    <h3 class="dropdown-item-title">
                                        ...
                                        <span class="float-right text-sm text-danger"><i
                                                class="fas fa-star text-success"></i></span>
                                    </h3>
                                ...
                                <div class="media-body">
                                    <h3 class="dropdown-item-title">
                                        ...
                                        <span class="float-right text-sm text-muted"><i
                                                class="fas fa-star text-danger"></i></span>
                                    </h3>
                                    ...
                                    <?php else: ?>
                                        <?php foreach ($produtos as $produto): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?= htmlspecialchars($produto['nota']); ?>
                                                </td>
                                                <td>
                                                    <?= htmlspecialchars($produto['valor']); ?>
                                                </td>


                                                <td class="td__operacao">
                                                    <a class="btnalterar" href="edit.php?id=<?= $produto['id']; ?>">Alterar</a>
                                                    <a class="btnexcluir" href="delete.php?id=<?= $produto['id']; ?>"
